...
\vspace{0cm}
\centerline{
\includegraphics[width=6cm]{images/logopolitonuovo}} 
\vspace{0.5cm}
...
\vspace{2.5cm}
\centerline{\Huge Secure OTA Update}
\bigskip
\centerline{\huge Project Report}
\vspace{2cm}
\vfill
\begin{minipage}{7.8cm} % modify this width in order to keep everything on the same line
\Large{Candidates:\\
